...
class OphLeIntravitrealinjectionModule extends BaseEventTypeModule
{
	...
	public function init()
	{
		...
		$this->setImport(array(
			'OphLeIntravitrealinjection.models.*',
			'OphLeIntravitrealinjection.components.*',
		));

		$this->moduleShortSuffix = "injection";
	}
